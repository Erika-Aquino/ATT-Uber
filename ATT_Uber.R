...
setwd("E:/doutorado/ATT Uber/Artigo Renato/Correções Renato/Dados mort_att_UFs")
...
autoplot(mort_att, mort_pad_att) +
        labs(title = "Mortalidade padronizada por LT, Brasil (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") +
        theme_minimal()+
...
## Média e desvio padrão da mortalidade por ATT Janeiro de 2000 a Dezembro de 2018, todas as capitais
mort_att_BR <- mort_att_BR %>%
        filter(month < yearmonth("2019 Jan"))

mort_att_BR

mort_att_BR %>% features(mort_pad_att, list(media_pre_RO = mean))

mort_att_BR %>% features(mort_pad_att, list(desv_pad_pre_RO = sd))



# Análise do impacto da pandemia na mortalidade por ATT segundo por UF
...
autoplot(mort_att_RO, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Porto Velho - RO (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_AC, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Rio Branco - AC (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_AM, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Manaus - AM (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_RR, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Boa Vista - RR (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_PA, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Belém - PA (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
# Modelo selecionado: ARIMA(2,1,3) 
...
autoplot(mort_att_AP, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Macapá - AP (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_TO, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Palmas - TO (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
# Modelo selecionado: ARIMA(0,0,1) with non-zero mean 
...
autoplot(mort_att_MA, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, São Luís - MA (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
mort_pre_MA %>% features(mort_pad_att, list(media_pos_MA = mean))

mort_pre_MA %>% features(mort_pad_att, list(desv_pad_pos_MA = sd))
...
# Modelo selecionado: ARIMA(3,0,2) with non-zero mean
...
autoplot(mort_att_PI, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Teresina - PI (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_CE, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Fortaleza - CE (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_RN, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Natal - RN (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_PB, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, João Pessoa - PB (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_PE, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Recife - PE (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
# Modelo selecionado: ARIMA(1,0,2) with non-zero mean 
...
autoplot(mort_att_AL, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Maceió - AL (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_SE, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Aracaju - SE (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_BA, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Salvador - BA (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_MG, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Belo Horizonte - MG (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_ES, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Vitória - ES (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_RJ, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Rio de Janeiro - RJ (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_SP, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, São Paulo - SP (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_PR, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Curitiba - PR (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_SC, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Florianópolis - SC (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_RS, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Porto Alegre - RS (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_MS, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Campo Grande - MS (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_MT, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Cuiabá - MT (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_GO, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Goiânia - GO (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
autoplot(mort_att_DF, mort_pad_att) +
        labs(title = "Mortalidade por Acidentes de Transporte Terrestre, Brasília - DF (Jan 2000 a Dez 2020)", 
             x = "Mês do óbito", 
             y = "Mortalidade redistribuída e padronizada (100 mil hab.)") + 
...
## AINDA NÃO ALTEREI DAQUI PRA BAIXO (ÉRIKA 29.08.2022)
...
## 1. São LuíS (MA)	ARIMA(0,0,0)(1,0,0)[12] with non-zero mean       

# Modelagem dos dados excluindo o período pós-pandemia
model2_s <- Arima(window(mort_pre_MA, end=c(2017,3)), order=c(0,0,0), seasonal=list(order=c(1,0,0), period=12, include.mean = TRUE))


# Previsão de 10 meses após a intervenção e conversão para objeto de série temporal
fc_s <- forecast(model2_s, h=12, level=c(95))
fc_s.ts <- ts(as.numeric(fc_s$mean), start=c(2017,4), frequency=12)

# Combinação com dados observados
ts.comb_s <- ts.union(mort_att_MA, fc_s.ts)
ts.comb_s

# Plotagem (previsto x observado)
tiff(filename = "Prev x Obs MA.tiff")
plot(ts.comb_s, type="l", plot.type="s", col=c('black','red'), ylim=c(0,6), main = "São Luís (MA)", xlab="Mês do óbito", ylab="Mortalidade redistribuída e padronizada (100 mil hab.)")
abline(v=2017.25, lty="dashed", col="blue")
dev.off()




## 2. Fortaleza (CE)	ARIMA(0,1,1)(0,0,1)[12]       

# Modelagem dos dados excluindo o período pós-pandemia
model2_s <- Arima(window(mort_pre_CE, end=c(2016,3)), order=c(0,1,1), seasonal=list(order=c(0,0,1), period=12))


# Previsão de 10 meses após a intervenção e conversão para objeto de série temporal
fc_s <- forecast(model2_s, h=12, level=c(95))
fc_s.ts <- ts(as.numeric(fc_s$mean), start=c(2016,4), frequency=12)

# Combinação com dados observados
ts.comb_s <- ts.union(mort_att_CE, fc_s.ts)
ts.comb_s

# Plotagem (previsto x observado)
tiff(filename = "Prev x Obs CE.tiff")
plot(ts.comb_s, type="l", plot.type="s", col=c('black','red'), ylim=c(0,6), main = "Fortaleza (CE)", xlab="Mês do óbito", ylab="Mortalidade redistribuída e padronizada (100 mil hab.)")
abline(v=2016.25, lty="dashed", col="blue")
dev.off()
...
## 3. Recife (PE)	ARIMA(2,0,1)(1,0,0)[12] with non-zero mean    

# Modelagem dos dados excluindo o período pós-pandemia
model2_s <- Arima(window(mort_pre_PE, end=c(2016,2)), order=c(2,0,1), seasonal=list(order=c(1,0,0), period=12), include.mean = TRUE)


# Previsão de 10 meses após a intervenção e conversão para objeto de série temporal
fc_s <- forecast(model2_s, h=12, level=c(95))
fc_s.ts <- ts(as.numeric(fc_s$mean), start=c(2016,3), frequency=12)

# Combinação com dados observados
ts.comb_s <- ts.union(mort_att_PE, fc_s.ts)
ts.comb_s

# Plotagem (previsto x observado)
tiff(filename = "Prev x Obs PE.tiff")
plot(ts.comb_s, type="l", plot.type="s", col=c('black','red'), ylim=c(0,6), main = "Recife (PE)", xlab="Mês do óbito", ylab="Mortalidade redistribuída e padronizada (100 mil hab.)")
abline(v=2016.20, lty="dashed", col="blue")
dev.off()
...
## 4. Belo Horizonte (MG)	ARIMA(0,1,1)
...
plot(ts.comb_s, type="l", plot.type="s", col=c('black','red'), ylim=c(0,6), main = "Belo Horizonte (MG)", xlab="Mês do óbito", ylab="Mortalidade redistribuída e padronizada (100 mil hab.)")
...
## 5. Rio de Janeiro (RJ)	ARIMA(0,1,2)(2,0,1)[12]

# Modelagem dos dados excluindo o período pós-pandemia
model2_s <- Arima(window(mort_pre_RJ, end=c(2014,4)), order=c(0,1,2), seasonal=list(order=c(2,0,1), period=12))
...
plot(ts.comb_s, type="l", plot.type="s", col=c('black','red'), ylim=c(0,6), main = "Rio de Janeiro (RJ)", xlab="Mês do óbito", ylab="Mortalidade redistribuída e padronizada (100 mil hab.)")
...
## 6. Cuiabá (MT)     ARIMA(2,0,2)(2,0,0)[12] with non-zero mean 

# Modelagem dos dados excluindo o período pós-pandemia
model2_s <- Arima(window(mort_pre_MT, end=c(2016,10)), order=c(2,0,2), seasonal=list(order=c(2,0,0), period=12),include.mean = TRUE)


# Previsão de 10 meses após a intervenção e conversão para objeto de série temporal
fc_s <- forecast(model2_s, h=12, level=c(95))
fc_s.ts <- ts(as.numeric(fc_s$mean), start=c(2016,11), frequency=12)

# Combinação com dados observados
ts.comb_s <- ts.union(mort_att_MT, fc_s.ts)
ts.comb_s

# Plotagem (previsto x observado)
tiff(filename = "Prev x Obs MT.tiff")
plot(ts.comb_s, type="l", plot.type="s", col=c('black','red'), ylim=c(0,6), main = "Cuiabá(MT))", xlab="Mês do óbito", ylab="Mortalidade redistribuída e padronizada (100 mil hab.)")
abline(v=2016.75, lty="dashed", col="blue")
dev.off()
